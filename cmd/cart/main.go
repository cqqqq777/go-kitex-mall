...
import (
	...
	"github.com/cqqqq777/go-kitex-mall/cmd/cart/initialize"
	...
	cart "github.com/cqqqq777/go-kitex-mall/shared/kitex_gen/cart/cartservice"
...
func main() {
	...
	impl := &CartServiceImpl{
		...
		ProductManager: &pkg.ProductManager{ProductService: productManager},
	}

	srv := cart.NewServer(impl,
